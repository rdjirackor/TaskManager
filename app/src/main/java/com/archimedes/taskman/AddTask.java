...
public class AddTask extends AppCompatActivity {
    ...
    @Override
        ...
        tx1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String TaskName = preferences.getString("TaskName0", "");
                String TaskDesc = preferences.getString("TaskDet0", "");
                String TaskNotes = preferences.getString("TaskNote0", "");

                Intent intent = new Intent(AddTask.this, EditTask.class);
                intent.putExtra("descriptionName", "TaskName: " + TaskName);
                intent.putExtra("descriptionDet", "TaskDesc:" + TaskDesc);
                intent.putExtra("descriptionNotes", "TaskNotes:" + TaskNotes);
